...
bool _isInAccessibilityMode(BuildContext context) {
  ...
  final double? scaledFontSize = MediaQuery.maybeTextScalerOf(
    context,
    ...
    return MediaQuery.removePadding(
      ...
      child: LayoutBuilder(
        builder: (BuildContext context, BoxConstraints constraints) {
          ...
          final double actionsMinWidth = _isInAccessibilityMode(context)
              ? constraints.maxWidth / 2 + _kDividerThickness
...
class CupertinoPopupSurface extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final ImageFilter? filter = _buildFilter(
...
class _CupertinoActionSheetState extends State<CupertinoActionSheet> {
  ...
  Widget? _buildContent(BuildContext context) {
    ...
    return ColoredBox(
      ...
      child: _CupertinoAlertContentSection(
        ...
        titlePadding: EdgeInsets.only(
          top: _kActionSheetContentHorizontalPadding,
          bottom: _kActionSheetContentHorizontalPadding,
          right: widget.message == null
              ? _kActionSheetContentVerticalPadding
              : 0.0,
          left: _kActionSheetContentVerticalPadding,
        ),
        messagePadding: EdgeInsets.only(
          top: _kActionSheetContentHorizontalPadding,
          bottom: _kActionSheetContentHorizontalPadding,
          right: _kActionSheetContentVerticalPadding,
          left:
              widget.title == null ? _kActionSheetContentVerticalPadding : 0.0,
        ),
        ...
        messageTextStyle: widget.title == null
            ? textStyle.copyWith(fontWeight: FontWeight.w600)
            : textStyle,
        additionalPaddingBetweenTitleAndMessage: const EdgeInsets.only(
          left: 4.0,
        ),
      ),
    );
  ...
  Widget _buildCancelButton() {
    ...
    final double cancelPadding = (widget.actions != null ||
        ...
        : 0.0;
    return Padding(
      padding: EdgeInsets.only(left: cancelPadding),
  ...
  double _topPadding(BuildContext context) {
    ...
    final double currentViewPadding = MediaQuery.viewPaddingOf(context).left;
  ...
  Widget build(BuildContext context) {
    ...
    final double actionSheetWidth = switch (MediaQuery.orientationOf(context)) {
      Orientation.portrait => MediaQuery.sizeOf(context).height * 0.5,
      Orientation.landscape => MediaQuery.sizeOf(context).width * 0.5,
    };

    return SafeArea(
      minimum: const EdgeInsets.only(right: _kActionSheetEdgePadding),
      child: ScrollConfiguration(
        // A CupertinoScrollbar is built-in below
        behavior: ScrollConfiguration.of(context).copyWith(scrollbars: false),
        child: Semantics(
          ...
          child: CupertinoUserInterfaceLevel(
            ...
            child: Padding(
              padding: EdgeInsets.only(
                top: _kActionSheetEdgePadding,
                bottom: _kActionSheetEdgePadding,
                left: _topPadding(context),
                // The bottom padding is set on SafeArea.minimum, allowing it to
                // be consumed by bottom view padding.
              ),
              child: SizedBox(
                height: actionSheetWidth - _kActionSheetEdgePadding * 2,
                child: _ActionSheetGestureDetector(
                  child: Semantics(
                    explicitChildNodes: true,
                    child: Row(
...
class _CupertinoActionSheetActionState extends State<CupertinoActionSheetAction>
  ...
  Widget build(BuildContext context) {
    ...
    final double contextBodySize = MediaQuery.textScalerOf(
      context,
      ...
      child: MetaData(
        ...
        child: ConstrainedBox(
          constraints: const BoxConstraints(
            minWidth: _kActionSheetButtonMinHeight,
          ),
          child: Semantics(
            button: true,
    ...
    final Widget overscroll = Row(
      ...
      children: <Widget>[
        DecoratedBox(
          ...
          child: SizedBox(width: _topOverscroll),
        ),
        DecoratedBox(
          decoration: BoxDecoration(color: widget.color),
          child: SizedBox(width: _bottomOverscroll),
        ),
      ],
    );
    return Stack(
  ...
  Widget build(BuildContext context) {
    if (actions == null || actions!.isEmpty) {
      return const LimitedBox(
        maxHeight: 0,
        child: SizedBox(height: double.infinity, width: 0),
      );
    }
...
class _ActionSheetMainSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return _PriorityColumn(
      left: contentSection!,
      right: _dividerAndActionsSection(context),
      rightMinWidth: _kActionSheetActionsSectionMinHeight + _kDividerThickness,
    );
  }
...
class _CupertinoAlertActionSection extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final Color dialogColor = CupertinoDynamicColor.resolve(
      _kDialogColor,
      context,
    );
    final Color dialogPressedColor = CupertinoDynamicColor.resolve(
      _kDialogPressedColor,
      context,
    );
    final Color dividerColor = CupertinoDynamicColor.resolve(
...
typedef _TwoChildrenWidths = ({double leftChildWidth, double rightChildWidth});
...
class _PriorityColumn extends MultiChildRenderObjectWidget {
  ...
  }) : super(children: <Widget>[left, right]);

  final double rightMinWidth;

  @override
  RenderObject createRenderObject(BuildContext context) {
    return _RenderPriorityColumn(rightMinWidth: rightMinWidth);
  }
  ...
  void updateRenderObject(
    ...
    renderObject.rightMinWidth = rightMinWidth;
  }
}
...
class _RenderPriorityColumn extends RenderFlex {
  _RenderPriorityColumn({
    List<RenderBox>? children,
    required double rightMinWidth,
  })  : _rightMinWidth = rightMinWidth,
        super(
  ...
  double get rightMinWidth => _rightMinWidth;
  double _rightMinWidth;
  set rightMinWidth(double newValue) {
    if (newValue != _rightMinWidth) {
      _rightMinWidth = newValue;
      markNeedsLayout();
    }
  }
  ...
  double computeMinIntrinsicWidth(double width) {
    assert(childCount == 2);
    return firstChild!.getMinIntrinsicWidth(width) +
        lastChild!.getMinIntrinsicWidth(width);
  }

  @override
  double computeMaxIntrinsicWidth(double width) {
    assert(childCount == 2);
    return firstChild!.getMaxIntrinsicWidth(width) +
        lastChild!.getMaxIntrinsicWidth(width);
  }
  ...
  Size computeDryLayout(covariant BoxConstraints constraints) {
    ...
    final (
      :double leftChildWidth,
      :double rightChildWidth,
    ) = _childrenWidths(maxWidth, height);
    return Size(leftChildWidth + rightChildWidth, height);
  }
  ...
  void performLayout() {
    ...
    size = Size(leftChildWidth + rightChildWidth, height);

    firstChild!.layout(
      BoxConstraints.tight(Size(leftChildWidth, height)),
      parentUsesSize: true,
    );
    (firstChild!.parentData! as FlexParentData).offset = Offset.zero;

    lastChild!.layout(
      BoxConstraints.tight(Size(rightChildWidth, height)),
      parentUsesSize: true,
    );
  ...
  _TwoChildrenWidths _childrenWidths(double maxWidth, double height) {
    assert(childCount == 2);
    final double leftIntrinsic = firstChild!.getMinIntrinsicWidth(height);
    final double rightIntrinsic = lastChild!.getMinIntrinsicWidth(height);
    // Try to layout both children as their intrinsic height.
    if (leftIntrinsic + rightIntrinsic <= maxWidth) {
      return (leftChildWidth: leftIntrinsic, rightChildWidth: rightIntrinsic);
    }
    // _bottomMinHeight is only effective when bottom actually needs that much.
    final double effectiveRightMinWidth = math.min(
      _rightMinWidth,
      rightIntrinsic,
    );
    // Try to layout top as intrinsics, as long as the bottom has at least
    // effectiveBottomMinHeight.
    if (maxWidth - leftIntrinsic >= effectiveRightMinWidth) {
      return (
        leftChildWidth: leftIntrinsic,
        rightChildWidth: maxWidth - leftIntrinsic,
      );
    }
    // Try to layout bottom as effectiveBottomMinHeight, as long as top has at
    // least 0.
    if (maxWidth >= effectiveRightMinWidth) {
      return (
        leftChildWidth: maxWidth - effectiveRightMinWidth,
        rightChildWidth: effectiveRightMinWidth,
      );
    }
    return (leftChildWidth: 0, rightChildWidth: maxWidth);
  }
}
